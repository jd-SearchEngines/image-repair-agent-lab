...
| EP03 | 局部错误不应整图重做；真实 Qwen 实跑显示 preservation 仍需验证 | EXP-B + REAL-EP03 | `assets/ep03_real/hero_case_01_board.png`, `runs/REAL-EP03/*/comparison_board.png` | `MASK_NOT_SUPPORTED`, OCR/VLM/human review not run; do not claim Local Repair won |
